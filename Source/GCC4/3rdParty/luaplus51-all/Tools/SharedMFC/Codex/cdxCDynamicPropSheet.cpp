...
{
//jj	if(!PressButton(PSBTN_CANCEL))
//jj	CPropertySheet::OnClose();
...
void cdxCDynamicPropSheet::OnTimer(UINT_PTR nIDEvent) 
{
...
void cdxCDynamicPropPage::OnTimer(UINT_PTR nIDEvent) 
{
