...
--Lua=import_type("LuaInterface.Lua")
OpenFileDialog=import_type("System.Windows.Forms.OpenFileDialog")
File=import_type("System.IO.File")
StreamReader=import_type("System.IO.StreamReader")
FileMode=import_type("System.IO.FileMode")
