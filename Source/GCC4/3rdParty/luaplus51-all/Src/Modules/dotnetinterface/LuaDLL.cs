...
//		const string LUADLL = BASEPATH + "lua51.dll";		// steffenj: use Lua 5.1.1 dll
//		const string LUALIBDLL = BASEPATH + "lua51.dll";	// steffenj: use Lua 5.1.1 dll
#if (DEBUG)
        const string LUADLL = "LuaPlus_1100.debug.dll";
        const string LUALIBDLL = "LuaPlus_1100.debug.dll";
		const string STUBDLL = BASEPATH + "luanet.debug.dll";
#else
		const string LUADLL = "LuaPlus_1100.dll";
		const string LUALIBDLL = "LuaPlus_1100.dll";
